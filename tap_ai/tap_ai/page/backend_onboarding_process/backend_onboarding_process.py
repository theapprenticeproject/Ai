...
from tap_ai.glific_integration import create_or_get_glific_group_for_batch, add_student_to_glific_for_onboarding, get_contact_by_phone
from tap_ai.api import get_course_level
...
def process_glific_contact(student, glific_group, course_level=None):
    ...
    if existing_contact and 'id' in existing_contact:
        ...
        if glific_group and glific_group.get("group_id"):
            from tap_ai.glific_integration import add_contact_to_group
        ...
        from tap_ai.glific_integration import update_contact_fields
